...
test-e2e:
	...
	docker create --network calc-test-e2e --name e2e-tests cypress/included:4.9.0 --browser chrome bash -c "junit2html results/cypress_result.xml results/cypress_result.html" || true
