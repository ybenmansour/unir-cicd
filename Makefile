...
test-e2e:
	...
	docker create --network calc-test-e2e --name e2e-tests  bash -c "cypress/included:4.9.0 --browser chrome && junit2html results/cypress_result.xml results/cypress_result.html "|| true
